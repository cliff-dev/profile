import pro2 from '../assets/Screenshot 2022-05-17 at 19.35.26.png';
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:items-stretch rounded-2xl shadow-green-900 shadow-2xl ">
      ...
      <div className="grid p-6 rounded place-content-center sm:p-8">
        <div className="max-w-md mx-auto text-center lg:text-right">
          <header>
            <h2 className="text-xl font-bold text-green-500 sm:text-3xl inline-flex items-center">Hollrapp <span className="hidden ml-2 h-px w-32 bg-green-500 sm:inline-block"></span></h2>
